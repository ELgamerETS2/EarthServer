...
public class ClaimGui {
	...
	public static Inventory GUI (Player p) {
		...
		Utils.createItemByte(inv, 251, 5, 1, 22, "&cClaim", "&7The 512x512 area you are standing in will be claimed and accessible only for you!");
		Utils.createItemByte(inv, 251, 13, 1, 24, "&cTeam Claim", "&7The 512x512 are you are standing in will be claimed and accessible to all builders!");
		...
		Utils.createItemByte(inv, 251, 14, 1, 41, "&cUnclaim", "&7Remove the claim you are standing in!");
		...
		Utils.createItem(inv, 340, 1, 5, "&cHelp", "&7Click here for info on claiming and commands for claiming with a radius!");
